...
#generate the plot
plot(filteredData$DateTime, filteredData$Sub_metering_1,type="l", col = "black", ylab="Energy sub metering", xlab= "", bg = "white")
lines(filteredData$DateTime, filteredData$Sub_metering_2,type="l", col = "red", ylab="Energy sub metering", xlab= "", bg = "white")
lines(filteredData$DateTime, filteredData$Sub_metering_3,type="l", col = "blue", ylab="Energy sub metering", xlab= "", bg = "white")
