...
#generate the plot
with(filteredData, {
  plot(DateTime, Sub_metering_1,type="l", col = "black", bg = "white", ylab="Energy sub metering", xlab= "")
  lines(DateTime, Sub_metering_2,type="l", col = "red", bg = "white", ylab="Energy sub metering", xlab="")
  lines(DateTime, Sub_metering_3,type="l", col = "blue", bg = "white", ylab="Energy sub metering", xlab= "")
  legend("topright", xjust = 0, legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = 1, col = c("black", "red", "blue"))
